...
namespace SonicRealms.Core.Moves
{
    public class GroundControl : Move
    {
        ...
        {//variable _axis es la q permite moviemento en derecha e izquierda con 1 y -1; el cero es stop
            // using (System.IO.StreamWriter file =
            //new System.IO.StreamWriter(@"C:\Users\ian45\Documents\WriteText.txt", true))
            // {
            //     if (Input.GetKeyDown("right") == true)
            //     {file.WriteLine("Correr Derecha");}
            //     if (Input.GetKeyDown("left") == true)
            //     { file.WriteLine("Correr Izquierda"); }
            //     if (Input.GetKeyDown("up") == true)
            //     { file.WriteLine("Mirar hacia arriba"); }
            //     if (Input.GetKeyDown("down") == true)
            //     { file.WriteLine("Mirar hacia abajo"); }
            // }
            if (_axis == 1) {
        ...
        public bool Accelerate(float magnitude, float timestep)
        {
            ...
            if (magnitude < 0.0f)
            {//Izquierda
                //System.IO.File.WriteAllText(@"C:\Users\ian45\Documents\WriteText.txt", "Correr Izquierda");
